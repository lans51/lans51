...
function SkyWrathHake.PrayToDog()	
	...
	if not NPC.HasState(SkyWrathHake.enemy, Enum.ModifierState.MODIFIER_STATE_HEXED) and not NPC.HasState(SkyWrathHake.enemy, Enum.ModifierState.MODIFIER_STATE_STUNNED) and not NPC.IsLinkensProtected(SkyWrathHake.enemy) then
